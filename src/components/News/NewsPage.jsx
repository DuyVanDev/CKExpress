...
export const NewsPage = ({ isHome = false }) => {
  ...
  return (
    <div className="container py-5 mx-auto px-4 md:px-0">
      {!isHome ? (
        <Breadcrumb
          items={[
            {
        ...
        <div>
          <h1 className="font-semibold text-4xl text-center text-main  lg:text-4xl">
            Những bài viết mới
          </h1>
          <div className="flex justify-center mx-auto mt-4">
            <span className="inline-block w-40 h-1 bg-main rounded-full"></span>
            <span className="inline-block w-3 h-1 mx-1 bg-main rounded-full"></span>
            <span className="inline-block w-1 h-1 bg-main rounded-full"></span>
          </div>
        </div>
      )}
